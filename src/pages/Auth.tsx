  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div animate={{ scale: [1.2, 1, 1.2], opacity: [0.2, 0.4, 0.2] }} transition={{ duration: 8, repeat: Infinity, delay: 2 }} className="absolute bottom-1/4 -right-32 w-96 h-96 bg-neon-magenta/20 rounded-full blur-[100px]" />
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <p className="text-muted-foreground text-center text-sm mb-6">
            {isLogin ? "Connectez-vous à votre espace" : "Créez votre compte NLOUNQ"}
          </p>

          {/* Google Button */}
          <Button variant="glass" className="w-full mb-4 gap-3" onClick={handleGoogleLogin} disabled={loading}>
