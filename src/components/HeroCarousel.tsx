    ...
    >
      ...
      <button
        ...
        style={{
          ...
          backgroundImage: `conic-gradient(from ${hue}deg,
            hsl(${hue} 100% 65%),
            hsl(${(hue + 60) % 360} 100% 65%),
            hsl(${(hue + 120) % 360} 100% 65%),
            hsl(${(hue + 180) % 360} 100% 65%),
            hsl(${(hue + 240) % 360} 100% 65%),
            hsl(${(hue + 300) % 360} 100% 65%),
            hsl(${hue} 100% 65%))`,
          ...
          boxShadow: `
            inset 0 0 60px hsl(${hue} 100% 65% / 0.45),
            0 0 40px hsl(${hue} 100% 65% / 0.75),
            0 0 90px hsl(${(hue + 180) % 360} 100% 65% / 0.55)`,
          cursor: "pointer",
          zIndex: 2,
          transition: "box-shadow .5s ease, background-image .5s ease",
        }}
      />
